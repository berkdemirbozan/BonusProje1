...
namespace BonusProje1.DataSet1TableAdapters {
    ...
    public partial class TBLDERSLERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BonusProje1.Properties.Settings.Default.BonusOkılConnectionString;
        }
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT TBL_OGRENCİLER.OGRID, TBL_OGRENCİLER.OGRAD, TBL_OGRENCİLER.OGRSOYAD, TBLKU" +
                "LUPLER.KULUPAD, TBL_OGRENCİLER.OGRCINSIYET\r\nFROM     TBL_OGRENCİLER INNER JOIN\r\n" +
                "                  TBLKULUPLER ON TBL_OGRENCİLER.OGRKULUP = TBLKULUPLER.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT TBL_OGRENCİLER.OGRID, TBL_OGRENCİLER.OGRAD, TBL_OGRENCİLER.OGRSOYAD, TBLKULUPLER.KULUPAD, TBL_OGRENCİLER.OGRCINSIYET
FROM     TBL_OGRENCİLER INNER JOIN
                  TBLKULUPLER ON TBL_OGRENCİLER.OGRKULUP = TBLKULUPLER.KULUPID
WHERE  (TBL_OGRENCİLER.OGRAD = @OGRAD)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO TBL_OGRENCİLER\r\n                  (OGRAD, OGRSOYAD, OGRKULUP, OGRCINS" +
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE TBL_OGRENCİLER\r\nSET          OGRAD = @OGRAD, OGRSOYAD = @OGRSOYAD, OGRKULU" +
                "P = @OGRKULUP, OGRCINSIYET = @OGRCINSIYET\r\nWHERE  (OGRID = @OGRID)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[4].CommandText = "DELETE FROM TBL_OGRENCİLER\r\nWHERE  (OGRID = @OGRID)";
